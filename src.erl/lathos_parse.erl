...
-file("src.erl/lathos_parse.yrl", 20).
...
-file("/usr/local/Cellar/erlang/R13B04/lib/erlang/lib/parsetools-2.0.2/include/yeccpre.hrl", 0).
%%
%% %CopyrightBegin%
%%
...
-file("src.erl/lathos_parse.erl", 255).
...
yeccgoto_terms(4, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_14(14, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_terms(8, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_9(9, Cat, Ss, Stack, T, Ts, Tzr);
yeccgoto_terms(11=_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_12(_S, Cat, Ss, Stack, T, Ts, Tzr).
...
-file("src.erl/lathos_parse.yrl", 4).
...
-file("src.erl/lathos_parse.yrl", 6).
...
-file("src.erl/lathos_parse.yrl", 5).
...
-file("src.erl/lathos_parse.yrl", 8).
...
-file("src.erl/lathos_parse.yrl", 9).
...
-file("src.erl/lathos_parse.yrl", 14).
...
-file("src.erl/lathos_parse.yrl", 11).
...
-file("src.erl/lathos_parse.yrl", 12).
...
-file("src.erl/lathos_parse.yrl", 90).
